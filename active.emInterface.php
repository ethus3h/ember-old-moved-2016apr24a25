...
// 		$this->test($this->adduser('test','fracture'),false,'Add user');
    ...
    function ui($action) {
		if(is_null($this->title)) {
     	...
     	$this->oappend('<div id="pageContents" style="position:fixed;top:0px;left:0px;display:none;">');
