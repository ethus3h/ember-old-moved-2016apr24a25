...
================================================================================
                     libdce. Version 2.5, 24 August 2013                        
================================================================================
...
* Split configuration out into config.php
...
require ('libdce_tools.php');
require ('libdce_request_handler.php');
...
if ($debug) {
    echo '<br><br>Log file location: <a href="' . $serverprefix . $libdceversion . $log_filepath_relative . '">' . $log_filepath_relative . '</a><br><br>';
