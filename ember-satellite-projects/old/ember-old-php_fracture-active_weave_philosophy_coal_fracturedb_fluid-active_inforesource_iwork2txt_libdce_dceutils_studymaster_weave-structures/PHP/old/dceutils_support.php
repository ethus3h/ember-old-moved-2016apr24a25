...
require ('dceutils_explode_escaped.php');
require ('dceutils_data.php');
include ('dceutils_legacy_functions.php');
require ('dceutils_x_to_dc.php');
require ('dceutils_dc_to_x.php');
include ('dceutils_tests.php');
$date = date('Y.m.d-H.i.s.u.Z-I');
function help()
{
    global $assistance;
    echo '<pre>' . $assistance . '</pre><h1>Utilities</h1><ul><li><a href="dceutils.php?tools=1&amp;action=async_converter">Asynchronous converter utility</li></ul>';
}
if ($help) {
    help();
}
...
$log_file_name = 'dceutils_log_' . date('Y.m.d-H.i.s.u.Z-I') . '.log';
