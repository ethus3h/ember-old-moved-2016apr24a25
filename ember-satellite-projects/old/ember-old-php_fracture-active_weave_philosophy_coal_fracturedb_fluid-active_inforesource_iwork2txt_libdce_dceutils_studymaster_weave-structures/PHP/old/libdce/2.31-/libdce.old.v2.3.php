...
* Added reporting for unknown input and output formats

* Fixed a bug in the DCE 3.0a write translator that resulted in missing
  boundedness markings

* Made Hex DCE filter always return uppercase results

* Improved placeholder management in UTF-8 output (now outputs replacement
  character instead of nulls, and does not output placeholders for boundedness
  markers)
