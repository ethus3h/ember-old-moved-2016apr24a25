...
// 		$this->test($this->adduser('test','fracture'),false,'Add user');
    ...
    function ui($action) {
     ...
     /* help from http://stackoverflow.com/questions/158319/cross-browser-onload-event-and-the-back-button/170478#170478 , http://stackoverflow.com/questions/3628536/history-back-doesnt-trigger-document-ready (by virtue of its reference to the other)
