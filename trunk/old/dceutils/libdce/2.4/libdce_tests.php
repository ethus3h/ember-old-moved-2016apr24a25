...
function libdce_tests()
{
    ...
    test_add('<h4>Begin DCE 3.01a tests</h4>');
    test_add('<h5>3_01a: This translator currently does not work well.</h5>');
    //test('UTF-8 to DCE 3.01a', dce_convert('Hello World!', 'utf8', '3_01a'), hex2bin('44434565020102FD8048656C6C6F20576F726C642181FD03'));
    test_add('<h5>hex_3_01a: This translator currently does not work well.</h5>');
    ...
    test_add('<h5>utf8_dc64: This translator currently does not work well.</h5>');
    ...
    test_add('<h5>utf8_dc64_enc: This translator currently does not work well.</h5>');
    ...
    test_add('<h5>utf8_dc64_bin: This translator currently does not work well.</h5>');
    ...
    test_add('<h5>utf8_dc64_bin_enc: This translator currently does not work well.</h5>');
    //test('UTF-8 to UTF-8 Base64 DCE binary fragment', dce_convert('Hello World!', 'utf8', 'utf8_dc64_bin_enc'), hex2bin('C3948897AE9D88BEA297B8BFB49D8892A3C4'));
    test_add('<h5>utf32</h5>');
