...
// 		$this->test($this->adduser('test','fracture'),false,'Add user');
    ...
    function ui_logo_fragment() {
		...
		if ($login == 1) {
			$ret=$ret.'&nbsp;&nbsp;(logged in)&nbsp;&nbsp;';
			$ret=$ret.$this->addLink('15', '', 'Log outâ€¦');
			$ret=$ret.'&#32;';
			$ret=$ret.$this->addLink('11', '', 'Operation indexâ€¦ ');
		} else {
			$ret=$ret.'&nbsp;&nbsp;(not logged in)&nbsp;&nbsp;';
			$ret=$ret.$this->addLink('logIn', 'recordId=' . fv('recordId') . '&', 'Log inâ€¦');
			$ret=$ret.'&#32;';
			$ret=$ret.$this->addLink('newUser', '', 'New userâ€¦');
			$ret=$ret.'&#32;';
			$ret=$ret.$this->addLink('operationIndex', '', 'Operation indexâ€¦ ');
		}
		return $ret;
    }
    ...
    function ui($action) {
     ...
     /* help from http://stackoverflow.com/questions/158319/cross-browser-onload-event-and-the-back-button/170478#170478 , http://stackoverflow.com/questions/3628536/history-back-doesnt-trigger-document-ready (by virtue of its reference to the other), and http://stackoverflow.com/questions/2638292/after-travelling-back-in-firefox-history-javascript-wont-run
     	/* history.navigationMode = \'compatible\'; */
     	$(document).ready(function()
     	{ $(\'#pagects\').delay(500).fadeIn(500);
     	...
     	$this->oappend('<body id="bodyContents"><div id="loadingbox"><div id="bgloading">Loadingâ€¦</div><br><div class="loading"></div></div><div id="pageContents" style="width:100%;height:100%;top:0px;left:0px;position:fixed;"></div><!-- <div id="pageShield" style="left:0px;top:0px;width:100%;height:100%;z-index:2;position:fixed;"></div> -->');
     	$this->oappend('<div id="pagects" style="height:100% !important;width:100% !important;background-color:#d5e3cf;position:fixed;top:0px;left:0px;display:none;align-items:flex-start;justify-content:flex-start;text-align:left;">');
     	//$this->oappend('Hello World!');
     	$this->oappend('<div class="greenpage"></div><div class="fh"><a href="/" id="tl"><i>futuramerlin</i></a></div><div id="content">');
     	$this->oappend($this->ui_logo_fragment());
     	$this->oappend($this->ui_breadcrumb_fragment());
     	$this->oappend($this->title);
     	$this->oappend('</h1>');
    	$this->oappend($this->body);
     	$this->oappend('</div><div class="floatbg"></div><div class="floattb"><a href="/" class="floatlink">Home</a> | <a href="javascript:history.back();" class="floatlink">Previous page</a> | <a href="/r.php?c=news&amp;a=main" class="floatlink">News</a> | <a href="/r.php?c=events&amp;a=main" class="floatlink">Events</a> | <a href="/r.php?c=articles&amp;a=main" class="floatlink">Articles</a> | <div style="display:inline;height:25px;margin-bottom:-4px;"><div style="display:inline-block;z-index:200;" id="projecthoverdiv" onMouseOver="show();" onMouseOut="hide();"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" alt="" onMouseOver="forcehide();" style="width:5px;height:30px;margin-left:-5px;margin-bottom:-5px;"><a class="floatlink" id="projectHoverLink" href="r.php?c=main&amp;a=projects">Projects</a><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" alt="" id="pngstretch" onMouseOver="forcehide();" style="width:5px;height:26px;margin-left:0px;margin-bottom:-5px;"></div></div><noscript><a href="r.php?c=main&amp;a=projects" class="floatlink">Projects</a></noscript></div><div id="projectsdisplaybg" style="display:none !important;position:fixed;bottom:25px;left:100px;width:250px;height:126px;background-color:#030007;opacity:0;z-index:180;display:none;"><div onMouseOver="persistin();" id="projectsdisplaydiv" style="display:none !important;position:fixed;bottom:26px;left:101px;width:250px;height:126px;opacity:.8;color:white;z-index:200;border:1px dotted white;"><ul style="text-align:left;"><li style="color:white;"><a style="color:white;" class="popuplink" href="../../r.php?c=Wreathe&amp;a=main">Wreathe</a></li><li style="color:white;"><a style="color:white;" class="popuplink" href="../../r.php?c=Ember&amp;a=main">Ember</a></li><li style="color:white;"><a style="color:white;" class="popuplink" href="../../r.php?c=DCE&amp;a=main">DCE</a></li><li style="color:white;"><a style="color:white;" class="popuplink" href="../../r.php?c=main&amp;a=music">Music</a></li><li style="color:white;"><a style="color:white;" class="popuplink" href="../../r.php?c=main&amp;a=more-projects">Moreâ€¦</a></li></ul></div></div><div id="pt" style="position:fixed;bottom:22px;left:100px;width:250px;height:126px;z-index:180;" onMouseOver="persistin();"></div><div id="triggerout" style="position:fixed;bottom:25px;left:100px;width:282px;height:142px;z-index:102;" onMouseOut="forcehide();"></div><div style="position:fixed;bottom:35px;right:10px;z-index:115 !important;"><a href="https://twitter.com/Futuramerlin" class="twitter-follow-button" data-show-count="false" data-dnt="true">Follow @Futuramerlin</a><script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?\'http\':\'https\';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+\'://platform.twitter.com/widgets.js\';fjs.parentNode.insertBefore(js,fjs);}}(document, \'script\', \'twitter-wjs\');</script></div></body>');
    ...
    function addLink($action,$options,$caption) {
		...
		if ($lttemp == true) {
			...
			if ($this->checkLogin()) {
				...
				$loginverifiedln = 0;
				$this->fail("Login not verified: Password does not match stored check â€” Probably the password provided was incorrect.");
				$loginbl = 0;
			}
