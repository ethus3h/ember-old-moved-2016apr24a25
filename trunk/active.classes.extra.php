...
class Document_F
{
    ...
    function __construct($content, $style, $title, $header = '@NULL@', $ppath = '', $headextras = '')
    {
        $this->content = $content;
        $this->style   = $style;
        $this->title   = $title;
        $this->ppath = $ppath;
        $this->headextras   = $headextras;
        if ($header == '@NULL@') {
            $this->header = '';
