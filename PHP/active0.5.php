<?php
#Futuramerlin Active Scripting Library. Version 0.5, 5 November 2013, and 6 November 2013 (a.mn.).
        ...
        foreach ($result as $key => $value) {
            ...
            if ($rowType == 'bool') {
                ...
                if ($rowType == 'text') {
                    ...
                    if ($rowType == 'int') {
                        echo print 'warning:Int, textfield only available! Data corruption may occur!';
                        $this->DBTextEntry($db, $table, $key, $id);
                    }
                }
            }
