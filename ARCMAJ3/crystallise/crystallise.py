...
print os.walk.filenames
if os.walk.filenames.length > 2:
	...
	def finish():
		...
		global title;
		global uuidG;
		os.system('mkdir ~/FuturamerlinMultimediaArchive/Nonfiction/Data/ColistarrCollectionIndex/\(`date +"%Y"`-`date +"%m"`-`date +"%d"`\)\ Crystallise_ColistarrPack_'+title+'_' + uuidG +'.' +timeRunning+'/';
		os.system('cp -Rv '+inf+'/.pbz-meta-'+now+'.AddedToPackedDirOnPack.pmb/ ~/FuturamerlinMultimediaArchive/Nonfiction/Data/ColistarrCollectionIndex/\(`date +"%Y"`-`date +"%m"`-`date +"%d"`\)\ Crystallise_ColistarrPack_'+title+'_' + uuidG +'.' +timeRunning+'/Packed-'+now+'.pmb/';
		os.system('mv -v ~/FuturamerlinMultimediaArchive/Nonfiction/Data/ColistarrCollectionIndex/\(`date +"%Y"`-`date +"%m"`-`date +"%d"`\)\ Crystallise_ColistarrPack_'+title+'_' + uuidG +'.' +timeRunning+'/Packed-'+now+'.pmb/.Packed-'+now+'.AddedToPackedDirOnPack.pdx ~/FuturamerlinMultimediaArchive/Nonfiction/Data/ColistarrCollectionIndex/\(`date +"%Y"`-`date +"%m"`-`date +"%d"`\)\ Crystallise_ColistarrPack_'+title+'_' + uuidG +'.' +timeRunning+'/Packed-'+now+'.pdx';
