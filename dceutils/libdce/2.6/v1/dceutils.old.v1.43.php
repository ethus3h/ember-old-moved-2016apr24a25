<?php
/*dceutils. Version 1.43, 28 December 2012.

This is the main script of dceutils, a library for conversion to and from DCE and related formats.

Changes in this version:
* Added description.
* Continuing work on DCE 3.01a support.
TODO: Write a better version of DcMapSendSimple (leave the old one there for DCE 3.01a compatibility though), and update the data table DcMapSend format while I'm at it
TODO: Think up a new architecture that will keep the various translators in separate files. This version is getting out of hand.
