...
function inforesource()
{
	...
	//some js from http://stackoverflow.com/questions/4742746/jquery-open-new-window-on-page-load, http://kbeezie.com/cross-browser-exit-pop/, and http://forums.devarticles.com/javascript-development-22/how-to-stop-browser-from-closing-using-javascript-8458.html
    ...
    echo '<html><head><title>' . $title . ' | ' . $displayType . 'Information Resource</title><script src="/d/jquery-2.1.0.min.js" type="text/javascript"></script><link type="text/css" rel="stylesheet" href="css/flat-ui.css"/><style type="text/css"> body {background-image: url(\'4278136735_20329c6cb7_o.jpg\'); background-size:cover;} #content { position: fixed; left: 1em; top:1em; right: 1em; bottom: 1em; background-color: rgba(255,255,255,0.3); } </style></head><body><script type="text/javascript">
function PopIt() { window.confirm("You are closing the window. do you want to continue. Click \'Ok\' to close or click \'Cancel\' to stay back"); document.write("<iframe width=\'100%\' height=\'100%\' frameborder=\'0\' src=\'http://futuramerlin.com/d/r/active.php?wint=1&wintNeeded=bnner\' marginwidth=\'0\' marginheight=\'0\' vspace=\'0\' hspace=\'0\' allowtransparency=\'true\' scrolling=\'no\'></iframe><a href=\\"http://www.paid-to-promote.net/member/signup.php?r=chelhi\\" target=\\"_blank\\"><img src=\\"http://www.paid-to-promote.net/images/ptp.gif\\" alt=\\"Get Paid To Promote, Get Paid To Popup, Get Paid Display Banner\\" width=\\"468\\" height=\\"60\\" border=\\"0\\" longdesc=\\"http://www.paid-to-promote.net/\\" /></a>"); }
